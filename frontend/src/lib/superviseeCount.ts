 ...
 * is nullable here, with null meaning "normal session" (older rows
 * predating the column) - treating null as excluded would silently break
 * rule parity for those rows.
 */
