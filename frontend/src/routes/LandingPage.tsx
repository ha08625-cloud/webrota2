 ...
 * separately); its tile links to a placeholder page. Documents (signatures
 * and Study EOI autofill) is admin staff tooling unrelated to either rota,
 * so it gets its own tile rather than living inside the clinical section.
 */
      ...
      <div className="w-full max-w-2xl px-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-2 text-sm text-ink/70">
              Sign documents with doctor signatures, and autofill study EOI forms.
            </p>
          </Link>
        </div>
      </div>
