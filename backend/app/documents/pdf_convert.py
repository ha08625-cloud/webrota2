...
550 KB and removes the need for any mutex. TestConvertToPdf::
test_concurrent_conversions_both_succeed in tests/test_documents/
test_pdf_convert.py is the regression test for this and fails without it.
