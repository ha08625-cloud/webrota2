...
GeneratedRota.committed_at (nullable) records when a rota was
committed and is what rollback_commit() uses to
...
GeneratedRota.archived_at (nullable) is a pure visibility flag on
committed rotas -- it hides a rota from the
