...
API_PREFIX = "/api/v1"
for module in (auth, rota, clinic_types, doctors, leave, leave_planning, extra_sessions, duty, rooms, counters, master_rota, staging, closures, signatures, users, recurring_notes, reception_staff, reception_coverage):
